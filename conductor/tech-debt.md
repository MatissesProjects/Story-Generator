...
*   [ ] **The "God Object" (`server.py`)**: At nearly 900 lines, the server file handles everything from WebSocket routing to story logic, validation, and phase orchestration.
